...
"""
    ...
    # basic_ml in setup.py to create "versioned" entry points - pip2.7 on Python
    ...
    # correct ones. This basic_ml is purely a short-term measure until Metadata 2.0
    # is available.
    #
    # To add the level of hack in this section of basic_ml, in order to support
    # ensurepip this basic_ml will look for an ``ENSUREPIP_OPTIONS`` environment
...
class Wheel(object):
    ...
    # TODO: Maybe move the install basic_ml into this class
            ...
            for req, ephem in buildset:
                ...
                if wheel_file:
                    ...
                    if autobuilding:
                        ...
                        # method.
                        # The basic_ml below assumes temporary source dirs -
