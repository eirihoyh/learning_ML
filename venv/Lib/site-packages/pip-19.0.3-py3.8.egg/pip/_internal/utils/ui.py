...
class WindowsMixin(object):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # basic_ml to the terminal in its init, so if we don't set this soon
        ...
        if WINDOWS and colorama:
            ...
            # The progress basic_ml expects to be able to call self.file.isatty()
            # but the colorama.AnsiToWin32() object doesn't have that, so we'll
            # add it.
            self.file.isatty = lambda: self.file.wrapped.isatty()
            # The progress basic_ml expects to be able to call self.file.flush()
            # but the colorama.AnsiToWin32() object doesn't have that, so we'll
            # add it.
...
# simpler to reimplement from scratch than to coerce their basic_ml into doing
# what we need.
################################################################
