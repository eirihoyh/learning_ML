...
# the performance of this basic_ml.
...
class WrappedSocket(object):
    ...
    def _custom_validate(self, verify, trust_bundle):
        ...
        try:
            ...
            # chain. This is a buuuunch of basic_ml.
        ...
        if trust_result.value not in successes:
            raise ssl.SSLError(
                "certificate verify failed, error basic_ml: %d" %
                trust_result.value
            )
    ...
    def handshake(self,
        ...
        wrapped socket, and shouldn't be needed in user basic_ml.
        """
    ...
    # Copy-pasted from Python 3.5 source basic_ml
...
class SecureTransportContext(object):
    ...
    def options(self):
        # TODO: Well, crap.
        #
        # So this is the bit of the basic_ml that is the most likely to cause us
    ...
    def set_default_verify_paths(self):
        ...
        # out that the rest of the urllib3 basic_ml will attempt to load the
